    ...
    <section className="container mx-auto font-rancho">
      ...
      <div className="px-4" data-aos="zoom-out">
        ...
        <p className="text-gray-700 text-xl">
          ...
          effective on all skin types. Following these simple things just might
          completely transform the way you take care of your skin and look
          naturally. If you’re curious to know what they are, read on…
        </p>
      </div>
